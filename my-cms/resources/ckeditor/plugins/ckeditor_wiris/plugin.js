!(function (e) {
            ...
            (js.Boot = function () {}),
                ...
                (js.Boot.__trace = function (e, t) {
                    ...
                    (i += js.Boot.__string_rec(e, "")),
                        "undefined" != typeof document && null != (n = document.getElementById("haxe:trace")) ? (n.innerHTML += js.Boot.__unhtml(i) + "<br/>") : "undefined" != typeof console && null != console.log && console.log(i);
                }),
                        ...
                        case "object":
                            ...
                            for (var d in e)
                                (h && !e.hasOwnProperty(d)) ||
                                    ("prototype" != d && "__class__" != d && "__super__" != d && "__interfaces__" != d && "__properties__" != d && (2 != i.length && (i += ", \n"), (i += t + d + " : " + js.Boot.__string_rec(e[d], t))));
                            return (i += "\n" + (t = t.substring(1)) + "}");
                        case "function":
                            return "<function>";
                        case "string":
    ...
    function (e, t, n) {
        ...
        function p(e, t) {
            ...
            if (t.singleton) {
                var l = s++;
                (n = a || (a = f(t))), (i = v.bind(null, n, l, !1)), (o = v.bind(null, n, l, !0));
            } else
    ...
    function (e, t, n) {
                ...
                (function (e, t, n) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            "_wrs_blackboard" in window &&
                                ...
                                (e = (e = (e = e.split(a).join(o.safeGoodBlackboardCharacters.ltElement)).split(s).join(o.safeGoodBlackboardCharacters.gtElement)).split(l).join(o.safeGoodBlackboardCharacters.ampElement)),
                            ...
                            e = (e = (e = (e = (e = e.split(t).join(o.xmlCharacters.tagOpener)).split(n).join(o.xmlCharacters.tagCloser)).split(i).join(o.xmlCharacters.doubleQuote)).split(c).join(o.xmlCharacters.ampersand))
                                .split(u)
                                .join(o.xmlCharacters.quote);
                            for (var d = "", h = null, m = 0; m < e.length; m += 1) {
                                var f = e.charAt(m);
                                null == h ? ("$" === f ? (h = "") : (d += f)) : ";" === f ? ((d += "&".concat(h)), (h = null)) : f.match(/([a-zA-Z0-9#._-] | '-')/) ? (h += f) : ((d += "$".concat(h)), (h = null), (m -= 1));
                            }
                            return d;
                        },
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return (e = (e = (e = (e = (e = e.split(t).join(o.safeXmlCharacters.tagOpener)).split(n).join(o.safeXmlCharacters.tagCloser)).split(i).join(o.safeXmlCharacters.doubleQuote))
                                .split(r)
                            ...
                            for (var t = "", n = 0; n < e.length; n += 1) {
                                ...
                                if (e.codePointAt(n) > 128) (t += "&#".concat(e.codePointAt(n), ";")), e.codePointAt(n) > 65535 && (n += 1);
                                    ...
                                    if (o >= 0) {
                                        ...
                                        (r.innerHTML = e.substring(n, o + 1)), (t += "&#".concat(w.fixedCharCodeAt(r.textContent || r.innerText, 0), ";")), (n = o);
                                    } else t += i;
                                } else t += i;
                            }
                            return t;
                ...
                (function (e, t, n) {
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return i
                                ? (void 0 === t || void 0 === t ? i.open("GET", e, !1) : "/" === e.substr(0, 1) || "http://" === e.substr(0, 7) || "https://" === e.substr(0, 8) ? i.open("POST", e, !1) : i.open("POST", n + e, !1),
                                  void 0 !== t && t ? (i.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8"), i.send(w.httpBuildQuery(t))) : i.send(null),
                                  i.responseText)
                                : "";
                        },
                    },
        ...
        (f._servicePaths = {}), (f._integrationPath = ""), (f._listeners = new h()), (f._parameters = {});
        var p = (function () {
            function e() {
                !(function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                    ...
                    },
                    {
                        ...
                        value: function (t, n) {
                            for (
                                ...
                                if (((l += t.substring(f, m)), -1 === (f = t.indexOf(u, m)) ? (f = t.length - 1) : (f += u.length), -1 !== (r = (i = t.substring(m, f)).indexOf(d)))) {
                                    (r += d.length), (s = i.indexOf(h));
                                    var g = i.substring(r, s);
                                    n === o.safeXmlCharacters && (g = a.safeXmlDecode(g)), (l += "$$".concat(g, "$$")), e.cache.populate(g, i);
                                } else l += i;
                                m = t.indexOf(c, f);
                            }
            ...
            return (
                (function (e, t, n) {
                    ...
                    },
                    {
                        ...
                        value: function (t, n) {
                            void 0 === n && (n = document),
                                (t = (t = (t = (t = t.split("<applet ").join('<span wirisObject="WirisApplet" ').split("<APPLET ").join('<span wirisObject="WirisApplet" '))
                                    .split("</applet>")
                                    .join("</span>")
                                    .split("</APPLET>")
                                    .join("</span>"))
                            ...
                            if ((n ? (o = t.contentWindow).focus() : ((o = window), t.focus()), document.selection && !i)) {
                                ...
                                if (r.parentElement) {
                                    ...
                                    var a,
                                        ...
                                        l = r.parentElement();
                                    return (
                                        "IMG" !== l.nodeName.toUpperCase() && (r.pasteHTML('<span id="wrs_openEditorWindow_temporalObject"></span>'), (l = o.document.getElementById("wrs_openEditorWindow_temporalObject"))),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return null === n ? null : { node: t, caretPosition: e.selectionStart, startPosition: n.startPosition, endPosition: n.endPosition };
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, n) {
                            ...
                            var o,
                                ...
                                a,
                                s = [];
                            for (o = n || ((r = "=" === t.charAt(t.length - 2) ? 2 : "=" === t.charAt(t.length - 1) ? 1 : 0) > 0 ? t.length - 4 : t.length), a = 0; a < o; a += 4)
                                (i = (e.decode64(t.charAt(a)) << 18) | (e.decode64(t.charAt(a + 1)) << 12) | (e.decode64(t.charAt(a + 2)) << 6) | e.decode64(t.charAt(a + 3))),
                                    s.push((i >> 16) & 255),
                                    s.push((i >> 8) & 255),
                                    s.push(255 & i);
                            return (
                                r &&
                                    (2 === r
                                        ...
                                        : 1 === r && ((i = (e.decode64(t.charAt(a)) << 10) | (e.decode64(t.charAt(a + 1)) << 4) | (e.decode64(t.charAt(a + 2)) >> 2)), s.push((i >> 8) & 255), s.push(255 & i))),
                                s
                            );
                        },
                    },
                            ...
                            if (i)
                                if ("svg" === l.get("imageFormat"))
                                    if ("base64" !== l.get("saveMode")) o = e.getMetricsFromSvgString(n);
                                        ...
                                        (r = t.src.substr(t.src.indexOf("base64,") + 7, t.src.length)), (s = ""), (a = w.b64ToByteArray(r, r.length));
                                        for (var c = 0; c < a.length; c += 1) s += String.fromCharCode(a[c]);
                                        o = e.getMetricsFromSvgString(s);
                                    }
                                else (r = t.src.substr(t.src.indexOf("base64,") + 7, t.src.length)), (a = w.b64ToByteArray(r, 88)), (o = e.getMetricsFromBytes(a));
                        ...
                        value: function (e) {
                            ...
                            for (w.readBytes(e, 0, 8); e.length >= 4; )
                                1229472850 === (i = w.readInt32(e))
                                    ...
                                    : 1650545477 === i
                                    ? (o = w.readInt32(e))
                                    : 1883789683 === i && ((r = w.readInt32(e)), (r = Math.round(r / 39.37)), w.readInt32(e), w.readByte(e)),
                                    w.readInt32(e);
                            if (void 0 !== t) {
                                var a = [];
                ...
                })(e, null, [
                    {
                        ...
                        value: function (t, n, i, o) {
                            ...
                            if (!l.get("wirisPluginPerformance") || ("xml" !== l.get("saveMode") && "safeXml" !== l.get("saveMode"))) {
                                ...
                                "png" === (d = d.result).format ? (r.src = "data:image/png;base64,".concat(d.content)) : (r.src = "data:image/svg+xml;charset=utf8,".concat(w.urlEncode(d.content))),
                                    r.setAttribute(l.get("imageMathmlAttribute"), a.safeXmlEncode(n)),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            if (-1 !== l.get("parseModes").indexOf("latex"))
                                for (var t = w.getElementsByNameFromString(e, "img", !0), n = 'encoding="LaTeX">', i = 0, o = 0; o < t.length; o += 1) {
                                    ...
                                    if (-1 !== r.indexOf(' class="'.concat(l.get("imageClassName"), '"'))) {
                                        ...
                                        if ((-1 === c && ((s = ' alt="'), (c = r.indexOf(s))), -1 !== c)) {
                                            ...
                                            if (-1 !== h) {
                                                ...
                                                (e = e.substring(0, t[o].start + i) + g + e.substring(t[o].end + i)), (i += g.length - (t[o].end - t[o].start));
                                            }
                                        }
                                    }
                                }
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return (
                                ...
                                (o.formula = com.wiris.js.JsPluginTools.md5encode(w.propertiesToString(n))),
                        ...
                        value: function (t, n) {
                            for (var i = "", o = 0, r = /<img/gi, s = r.source.length; r.test(t); ) {
                                ...
                                var m = t.substring(c, o),
                                    ...
                                    p = void 0,
                                    _ = void 0;
                                if ("base642showimage" === n) null == g && (g = f.getAttribute("alt")), (g = a.safeXmlDecode(g)), (m = e.mathmlToImgObject(document, g, null, null)), (i += w.createObjectCode(m));
                                else if ("img2mathml" === n) l.get("saveMode") && ("safeXml" === l.get("saveMode") ? ((p = !0), (_ = !0)) : "xml" === l.get("saveMode") && ((p = !0), (_ = !1))), (i += w.getWIRISImageOutput(m, p, _));
                                else if ("img264" === n) {
                                    null === g && (g = f.getAttribute("alt")), (g = a.safeXmlDecode(g));
                                    var v = { base64: "true" };
                                    (m = e.mathmlToImgObject(document, g, v, null)), A.setImgSize(m, m.src, !0), (i += w.createObjectCode(m));
                                }
                            }
                    ...
                    },
                    {
                        ...
                        value: function (t, n, i) {
                            for (var r = "", s = "".concat(n.tagOpener, "math"), c = "".concat(n.tagOpener, "/math").concat(n.tagCloser), u = t.indexOf(s), d = 0; -1 !== u; ) {
                                ...
                                if ((-1 === (d = t.indexOf(c, u)) ? (d = t.length - 1) : (d += -1 !== h ? t.indexOf("/>", u) : c.length), a.isMathmlInAttribute(t, u) || -1 !== h)) r += t.substring(u, d);
                                else {
                                    var m = t.substring(u, d);
                                    (m = n.id === o.safeXmlCharacters.id ? a.safeXmlDecode(m) : a.mathMLEntities(m)), (r += w.createObjectCode(e.mathmlToImgObject(document, m, null, i)));
                                }
                                u = t.indexOf(s, d);
                            }
        ...
        var j = (function () {
            function e(t) {
                ...
                if (((this.editorAttributes = t.editorAttributes), (this.customEditors = null), "customEditors" in t && (this.customEditors = t.customEditors), (this.environment = {}), !("environment" in t)))
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (n.href = t),
                                ...
                                (t = "80" === n.port || "443" === n.port ? "".concat(n.protocol, "//").concat(n.hostname, "/").concat(n.pathname) : "".concat(n.protocol, "//").concat(n.hostname, ":").concat(n.port, "/").concat(n.pathname));
                            var i = {};
                        ...
                        value: function () {
                            this.deviceProperties.isAndroid || this.deviceProperties.isIOS
                                ? this.editor.getEditorModel().isRTL()
                                    ? this.setMathML('<math dir="rtl"><semantics><annotation encoding="application/json">[]</annotation></semantics></math>', !0)
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                "general" === e && (e = "undefined" == typeof _wrs_int_wirisProperties || void 0 === _wrs_int_wirisProperties.toolbar ? "general" : _wrs_int_wirisProperties.toolbar),
                                e
                            );
                        },
                    },
                        ...
                        value: function (e) {
                            if (void 0 !== e.key && !1 === e.repeat)
                                if ("Escape" === e.key || "Esc" === e.key) {
                                    ...
                                    if (document.activeElement === this.modalDialogInstance.cancelButton) document.querySelector('[title="Manual"]').focus(), e.stopPropagation(), e.preventDefault();
                                    else
                        ...
                        value: function (e) {
                            void 0 !== e.key &&
                                ("Escape" === e.key || "Esc" === e.key
                                    ...
                                    : "Tab" === e.key && (document.activeElement === this.closeButton ? this.cancelButton.focus() : this.closeButton.focus(), e.stopPropagation(), e.preventDefault()));
                        },
                    },
                ]),
                e
        ...
        var U = (function () {
            function e(t) {
                ...
                (this.instanceId = document.getElementsByClassName("wrs_modal_dialogContainer").length),
                    (this.deviceProperties = { orientation: l ? "landscape" : "portait", isAndroid: o, isIOS: r, isMobile: h, isDesktop: !h && !r && !o }),
                    (this.properties = { created: !1, state: "", previousState: "", position: { bottom: 0, right: 10 }, size: { height: 338, width: 580 } }),
                ...
                (m.id = this.getElementId(m.class)),
                    ...
                    (this.submitButton = this.createSubmitButton({ id: this.getElementId("wrs_modal_button_accept"), class: "wrs_modal_button_accept", innerHTML: b.get("accept") }, this.submitAction.bind(this))),
                    (this.cancelButton = this.createSubmitButton({ id: this.getElementId("wrs_modal_button_cancel"), class: "wrs_modal_button_cancel", innerHTML: b.get("cancel") }, this.cancelAction.bind(this))),
                ...
                X(e, [
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            return new ((function () {
                                function n() {
                                    R(this, n), (this.element = document.createElement("button")), (this.element.id = e.id), (this.element.className = e.class), (this.element.innerHTML = e.innerHTML), w.addEvent(this.element, "click", t);
                                }
                                return (
                                    X(n, [
                                        {
                        ...
                        value: function () {
                            this.titleBar.appendChild(this.closeDiv),
                                ...
                                this.deviceProperties.isDesktop
                                    ? (this.createModalWindowDesktop(), this.createResizeButtons(), this.addListeners(), l.get("modalWindowFullScreen") && this.maximize())
                                ...
                                this.isRTL() && ((this.container.style.right = "".concat(window.innerWidth - this.scrollbarWidth - this.container.offsetWidth, "px")), (this.container.className += " wrs_modal_rtl"));
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            w.addClass(document.body, "wrs_noselect"),
                                ...
                                t ? (this.leftScale = !0) : ((this.initialRight = parseInt(this.container.style.right, 10)), (this.initialBottom = parseInt(this.container.style.bottom, 10))),
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                this.properties.created
                                    ? (this.properties.open || ((this.properties.open = !0), this.deviceProperties.isAndroid || this.deviceProperties.isIOS || this.restoreState()),
                                      this.deviceProperties.isDesktop && l.get("modalWindowFullScreen") && this.maximize(),
                                      this.deviceProperties.isIOS && ((this.iosSoftkeyboardOpened = !1), this.setContainerHeight("".concat(100 + this.iosMeasureUnit))))
                                    : this.create(),
                            ...
                            this.saveModalProperties(),
                                "minimized" === this.properties.state && "stack" === this.properties.previousState
                                    ...
                                    : ((this.container.style.height = "30px"),
                                      ...
                                      w.containsClass(this.overlay, "wrs_stack") ? this.removeClass("wrs_stack") : this.removeClass("wrs_maximized"),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.saveModalProperties(),
                                "maximized" !== this.properties.state && ((this.properties.previousState = this.properties.state), (this.properties.state = "maximized")),
                                this.setResizeButtonsVisibility(),
                                w.containsClass(this.overlay, "wrs_minimized")
                                    ? ((this.minimizeDiv.title = b.get("minimize")), this.removeClass("wrs_minimized"))
                                    : w.containsClass(this.overlay, "wrs_stack") && ((this.container.style.left = null), (this.container.style.top = null), this.removeClass("wrs_stack")),
                    ...
                    },
                    {
                        key: "eventClient",
                        value: function (e) {
                            return void 0 === e.clientX && e.changedTouches ? { X: e.changedTouches[0].clientX, Y: e.changedTouches[0].clientY } : { X: e.clientX, Y: e.clientY };
                        },
                    },
                    {
                        key: "startDrag",
                                ...
                                l < 0 && (l = 0),
                                    ...
                                    this.leftScale ||
                                        (this.resizeDataObject.x - l - this.initialWidth < -580
                                            ...
                                            : ((this.container.style.right = "".concat(this.initialRight + this.initialWidth - 580, "px")), (this.container.style.width = "580px")),
                                        this.resizeDataObject.y - c < this.initialHeight - 338
                                            ...
                                            : ((this.container.style.bottom = "".concat(this.initialBottom + this.initialHeight - 338, "px")), (this.container.style.height = "338px"))),
                                    this.recalculateScale(),
                                    this.recalculatePosition();
                            }
                        },
                            ...
                            void 0 !== e.key &&
                                ("block" !== this.popup.overlayWrapper.style.display
                                    ? "Escape" === e.key || "Esc" === e.key
                                        ...
                                        : "Tab" === e.key && (document.activeElement === this.submitButton ? (this.cancelButton.focus(), e.stopPropagation(), e.preventDefault()) : this.contentManager.onKeyDown(e))
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            parseInt(this.container.style.width, 10) > 580
                                ? ((this.container.style.width = "".concat(Math.min(parseInt(this.container.style.width, 10), window.innerWidth - this.scrollbarWidth), "px")), (e = !0))
                                : ((this.container.style.width = "580px"), (e = !0)),
                                parseInt(this.container.style.height, 10) > 338
                                    ? ((this.container.style.height = "".concat(Math.min(parseInt(this.container.style.height, 10), window.innerHeight), "px")), (e = !0))
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.iosSoftkeyboardOpened ||
                                ...
                                (this.portraitMode() ? this.setContainerHeight("63".concat(this.iosMeasureUnit)) : this.setContainerHeight("40".concat(this.iosMeasureUnit))),
        ...
        String.prototype.codePointAt ||
            (function () {
                ...
                Object.defineProperty ? Object.defineProperty(String.prototype, "codePointAt", { value: e, configurable: !0, writable: !0 }) : (String.prototype.codePointAt = e);
            })(),
        ...
        var J = (function () {
            function e(t) {
                ...
                if (
                    (this.customEditors.addEditor("chemistry", { name: "Chemistry", toolbar: "chemistry", icon: "chem.png", confVariable: "chemEnabled", title: "ChemType", tooltip: "Insert a chemistry formula - ChemType" }),
                    (this.environment = {}),
                    ...
                    [
                            ...
                            value: function () {
                                ...
                                if (e.initialized) this.listeners.fire("onLoad", {});
                                    ...
                                    var n = h.newListener("onInit", function () {
                                        var e = f.getService("configurationjs", "", "get"),
                                            n = JSON.parse(e);
                                        l.addConfiguration(n), l.addConfiguration(z), (b.language = t.language), t.listeners.fire("onLoad", {});
                                    });
                                    f.addListener(n), f.init(this.serviceProviderProperties), (e.initialized = !0);
                                }
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (t, n) {
                                ...
                                return (
                                    ...
                                    this.listeners.fire("onBeforeFormulaInsertion", i) ? {} : e.globalListeners.fire("onBeforeFormulaInsertion", i) ? {} : { mathml: i.mathml, wirisProperties: i.wirisProperties }
                                );
                            },
                        },
                        {
                            ...
                            value: function (e, t, n) {
                                if (this.editionProperties.isNewElement)
                                    if (e)
                                        if ("textarea" === t.type) w.updateTextArea(t, e.textContent);
                                            ...
                                            if (
                                                ...
                                                "parentElement" in i || (n.document.execCommand("delete", !1), (i = n.document.selection.createRange()), n.document.execCommand("InsertImage", !1, e.src)),
                                                "parentElement" in i)
                                            ) {
                                                var o = i.parentElement();
                                                "IMG" === o.nodeName.toUpperCase() ? o.parentNode.replaceChild(e, o) : i.pasteHTML(w.createObjectCode(e));
                                            }
                                        } else {
                                    ...
                                    document.selection && 0 === document.getSelection
                                        ? ((this.editionProperties.isNewElement = !0), this.editionProperties.latexRange.select(), this.insertElementOnSelection(e, t, n))
                                        : (this.editionProperties.latexRange.deleteContents(), this.editionProperties.latexRange.insertNode(e), this.placeCaretAfterNode(e));
                                else if ("textarea" === t.type) {
                                    var d;
                                    (d = void 0 !== this.integrationModel.getSelectedItem ? this.integrationModel.getSelectedItem(t, !1) : w.getSelectedItemOnTextarea(t)),
                                        w.updateExistingTextOnTextarea(t, e.textContent, d.startPosition, d.endPosition);
                                } else
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                                ...
                                                if (c) {
                                                    ...
                                                    if ("textarea" !== e.tagName.toLowerCase())
                                                        if (document.selection) {
                                                            for (var m = 0, f = c.startNode.previousSibling; f; ) (m += w.getNodeLength(f)), (f = f.previousSibling);
                                ...
                                for (var g = l.get("editorAttributes").split(", "), _ = {}, v = 0, b = g.length; v < b; v += 1) {
                                    var y = g[v].split("="),
                                        x = y[0],
                                        A = y[1];
                                    _[x] = A;
                                ...
                                if (((E.editorAttributes = C), (E.language = this.language), (E.customEditors = this.customEditors), (E.environment = this.environment), null == this.modalDialog)) {
                                    ...
                                    var I = a.safeXmlDecode(this.editionProperties.temporalImage.getAttribute(l.get("imageMathmlAttribute")));
        ...
        var Y = (function () {
            function e(t) {
                ...
                if (
                    ...
                    "configurationService" in t && ((this.serviceProviderProperties.URI = t.configurationService), console.warn("Deprecated property configurationService. Use serviceParameters on instead.", [t.configurationService])),
                ...
                (function (e, t, n) {
                ...
                })(e, [
                    {
                        ...
                        value: function () {
                            ...
                            (a = 0 === a.indexOf("/") || 0 === a.indexOf("http") ? a : w.concatenateUrl(this.getPath(), a)), (this.serviceProviderProperties.URI = a);
                            var s = {};
        ...
        var ee = (function (e) {
            function t(e) {
                ...
                return (
                    ...
                    ((n = Z(this, G(t).call(this, e))).integrationFolderName = "ckeditor_wiris"),
                    n
                );
            }
            return (
                ...
                (function (e, t, n) {
                                  ...
                                  e.on(
                                      ...
                                      function () {
                                          e.on(
                                              "doubleclick",
                                              function (e) {
                                                  (("img" == e.data.element.$.nodeName.toLowerCase() && w.containsClass(e.data.element.$, l.get("imageClassName"))) || w.containsClass(e.data.element.$, l.get("CASClassName"))) &&
                                                      (e.data.dialog = null);
                                              }.bind(this)
                                          );
                                      }.bind(this)
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e,
                                t = this.editorObject,
                                n = document.getElementById("cke_contents_" + t.name) ? document.getElementById("cke_contents_" + t.name) : document.getElementById("cke_" + t.name),
                                i = !1;
                            if (!(e = t.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? t.container.$ : n.getElementsByTagName("iframe")[0])) {
                                var o;
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            if ("img" == e.nodeName.toLowerCase() && w.containsClass(e, l.get("imageClassName"))) {
                                void 0 !== t.stopPropagation ? t.stopPropagation() : (t.returnValue = !1), this.core.getCustomEditors().disable();
                                var n = e.getAttribute(l.get("imageCustomEditorName"));
                                n && this.core.getCustomEditors().enable(n), (this.core.editionProperties.temporalImage = e), this.openExistingFormulaEditor();
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        key: "getSelection",
                        value: function () {
                            return this.editorObject.document.getBody();
                        },
                    },
                    {
                        key: "callbackFunction",
                        value: function () {
                            q(G(t.prototype), "callbackFunction", this).call(this), this.addEditorListeners();
                        },
                    },
                ]),
                t
        ...
        CKEDITOR.plugins.add("ckeditor_wiris", {
            init: function (e) {
                e.ui.addButton("ckeditor_wiris_formulaEditor", { label: "Insert a math equation - MathType", command: "ckeditor_wiris_openFormulaEditor", icon: CKEDITOR.plugins.getPath("ckeditor_wiris") + "./icons/formula.png" }),
                    ...
                    e.on("instanceReady", function () {
                        ...
                        (t.editorObject = e),
                            ...
                            "wiriscontextpath" in e.config &&
                                ((t.configurationService = e.config.wiriscontextpath + t.configurationService), console.warn("Deprecated property wiriscontextpath. Use mathTypeParameters on instead.", e.config.wiriscontextpath)),
                            "mathTypeParameters" in e.config && (t.integrationParameters = e.config.mathTypeParameters);
                        var n = new ee(t);
                        n.init(), n.listeners.fire("onTargetReady", {}), (WirisPlugin.instances[e.name] = n), (WirisPlugin.currentInstance = n);
                    });
            },
        });
        var ne = (function () {
        ...
        window.WirisPlugin = { Core: J, Parser: E, Image: A, Util: w, Configuration: l, Listeners: h, IntegrationModel: Y, currentInstance: null, instances: {}, CKEditor4Integration: ee, Latex: p, Test: ne };
    },
]);
